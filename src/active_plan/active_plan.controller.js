...
export const get_all_active_plans = async (req, res) => {
    try {
        ...
        if(!filter_field || !filter_value) {
            const active_plans = await active_plan_service.get_all_active_plans(page, limit);
            ...
            const active_plans = await active_plan_service.filter_active_plans(filter_field, filter_value, page, limit);
