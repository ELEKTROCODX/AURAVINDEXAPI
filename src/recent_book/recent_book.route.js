...
recent_book_router.get('/:id', auth_middleware, validate_permission(app_config.PERMISSIONS.READ_RECENT_BOOK), recent_book_controller.get_recent_book_by_id);
recent_book_router.post('/', auth_middleware, validate_permission(app_config.PERMISSIONS.CREATE_RECENT_BOOK), recent_book_controller.create_recent_book);
