...
export class NotificationAlreadyMarkedAsRed extends Error {
    constructor() {
        super('This notification has already been marked as read.');
        this.name = 'NotificationAlreadyMarkedAsRed';
    }
}