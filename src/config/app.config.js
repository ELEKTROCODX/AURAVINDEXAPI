...
export const app_config = {
    ...
    ALERT_TYPE_MESSAGE_MAX_LENGTH: 50,
    ...
    EQUIPMENT_INVENTORY_MAX_LENGTH: 10,
    EQUIPMENT_BRAND_MAX_LENGTH: 30,
    FEE_TYPE_MESSAGE_MAX_LENGTH: 100,
    GENDER_NAME_MAX_LENGTH: 10,
    LOAN_MAX_RETURN_DAYS: 14,
    LOAN_MAX_RETURN_DAYS_AFTER_RENEWAL: 14,
    LOAN_MAX_ACTIVE_LOANS_PER_USER: 10,
    LOAN_MAX_RENEWALS_PER_LOAN: 3,
    ROLE_NAME_MAX_LENGTH: 20,
    RESERVATION_MAX_TIME_HOURS: 4,
    ROOM_NAME_MAX_LENGTH: 30,
    USER_USERNAME_MAX_LENGTH: 10,
    ...
    PERMISSIONS: {
        ...
        READ_ALERT_TYPE: 'READ_ALERT_TYPE',
        CREATE_ALERT_TYPE: 'CREATE_ALERT_TYPE',
        UPDATE_ALERT_TYPE: 'UPDATE_ALERT_TYPE',
        DELETE_ALERT_TYPE: 'DELETE_ALERT_TYPE',
        ...
        READ_ROOM_LOCATION: 'READ_ROOM_LOCATION',
        CREATE_ROOM_LOCATION: 'CREATE_ROOM_LOCATION',
        UPDATE_ROOM_LOCATION: 'UPDATE_ROOM_LOCATION',
        DELETE_ROOM_LOCATION: 'DELETE_ROOM_LOCATION',

        READ_ROOM_STATUS: 'READ_ROOM_STATUS',
        CREATE_ROOM_STATUS: 'CREATE_ROOM_STATUS',
        UPDATE_ROOM_STATUS: 'UPDATE_ROOM_STATUS',
        DELETE_ROOM_STATUS: 'DELETE_ROOM_STATUS',
