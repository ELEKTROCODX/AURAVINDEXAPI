...
/* Approve loan */
loan_router.put('/:id/approve/', auth_middleware, validate_permission(app_config.PERMISSIONS.APPROVE_LOAN), loan_validator.loan_validation_rules_get_id, validate, loan_controller.approve_loan);
